class SymbolTable:
    ...
    def create(self, name, symbol_type, scope, value=None, datatype=None, returntype=None):
    ...
    def update(self, name, symbol_type=None, scope=None, value=None, datatype=None, returntype=None):
        if name in self.table:
